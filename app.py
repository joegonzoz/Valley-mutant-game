...
def game_choice():
    ...
    if digits == "1":
        ...
        response.say("The last train of the night pulls up, but the conductor isnâ€™t human.")
...
def payphone_choice():
    ...
    if digits == "1":
        ...
        response.say("You hang up. The payphone rings again. This time, it sounds like itâ€™s inside your head.")
    elif digits == "3":
